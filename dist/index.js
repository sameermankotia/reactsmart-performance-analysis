...
var ReactSmartContext = /*#__PURE__*/React.createContext({
...
var ReactSmartProvider = function ReactSmartProvider(_ref) {
  ...
  var behaviorAnalysis = React.useRef(null);
  var predictionEngine = React.useRef(null);
  var componentLoader = React.useRef(null);
  var predictionWorker = React.useRef(null);

  // Debugging logger
  var logger = React.useRef({
  ...
  React.useEffect(function () {
    ...
    if (window.Worker && options.compatibility !== 'legacy') {
      try {
        predictionWorker.current = new Worker(new URL('../workers/prediction-worker.js', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.js', document.baseURI).href))));
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ReactSmartContext.Provider, {
    value: contextValue,
    children: children
  });
};
...
var withReactSmart = function withReactSmart(WrappedComponent) {
  ...
  var WithReactSmart = /*#__PURE__*/React.forwardRef(function (props, ref) {
    ...
    var _useContext = React.useContext(ReactSmartContext),
    ...
    var visibilityObserverRef = React.useRef(null);
    var mountTimeRef = React.useRef(null);
    ...
    return /*#__PURE__*/jsxRuntime.jsx(WrappedComponent, _objectSpread2(_objectSpread2({}, props), {}, {
      ref: componentRef,
      rootRef: setRootRef,
...
var SmartRoute = function SmartRoute(_ref) {
  ...
  var WrappedComponent = function WrappedComponent(props) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(Component, _objectSpread2({}, props));
  };
  WrappedComponent.displayName = "SmartRoute(".concat(Component.displayName || Component.name || 'Component', ")");

  // Return enhanced Route
  return /*#__PURE__*/jsxRuntime.jsx(reactRouterDom.Route, _objectSpread2(_objectSpread2({
    path: path
  }, rest), {}, {
    render: function render(routeProps) {
      return /*#__PURE__*/jsxRuntime.jsx(WrappedComponent, _objectSpread2({}, routeProps));
    }
  }));
};
...
if (typeof reactRouterDom.Route.render === 'undefined') {
...
var useComponentTracker = function useComponentTracker(componentId) {
  ...
  var rootRef = React.useRef(null);
  var isVisibleRef = React.useRef(false);
  var visibilityObserverRef = React.useRef(null);
  var mountTimeRef = React.useRef(null);
  ...
  // Track click events
  var trackClickEvent = React.useCallback(function (event) {
  ...
  // Track hover events
  var trackHoverEvent = React.useCallback(function (event) {
    var customData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    if (!isInitialized) return;
    trackInteraction(resolvedComponentId, _objectSpread2({
      type: 'hover',
  ...
  var trackCustomInteraction = React.useCallback(function (interactionType) {
    var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    if (!isInitialized) return;
    trackInteraction(resolvedComponentId, _objectSpread2({
  ...
  var preloadDependencies = React.useCallback(function () {
    if (!isInitialized) return;
    dependencies.forEach(function (depId) {
      preloadComponent(depId);
    });
...
var useNetworkAware = function useNetworkAware() {
  ...
  var _useState = React.useState(networkStatus),
    _useState2 = _slicedToArray(_useState, 2),
   ...
   */
  var meetsQualityThreshold = React.useCallback(function (minimumQuality) {
   ...
   */
  var getAdaptiveSize = React.useCallback(function () {
   ...
   */
  var selectResourceVariant = React.useCallback(function (variants) {
   ...
   */
  var estimateLoadTime = React.useCallback(function (sizeKB) {
...
exports.AdaptiveLoadingQueue = AdaptiveLoadingQueue;
exports.BehaviorAnalysis = BehaviorAnalysis;
exports.DynamicComponentLoader = DynamicComponentLoader;
exports.MarkovChain = MarkovChain;
exports.PredictionEngine = PredictionEngine;
exports.ProbabilisticModel = ProbabilisticModel;
exports.ReactSmartContext = ReactSmartContext;
exports.ReactSmartProvider = ReactSmartProvider;
exports.SmartRoute = SmartRoute;
exports.TransformerModel = TransformerModel;
exports.useComponentTracker = useComponentTracker;
exports.useNetworkAware = useNetworkAware;
exports.withReactSmart = withReactSmart;
